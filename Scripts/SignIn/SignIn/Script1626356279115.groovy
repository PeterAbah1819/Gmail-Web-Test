...
WebUI.click(findTestObject('Object Repository/Page_Sign in  Google accounts/input_Too many failed attempts_c7'))

WebUI.click(findTestObject('Object Repository/Page_Sign in  Google accounts/div_Show password'))
